...
from overcooked_ai_py.agents.agent import AgentPair, ParallelAgentPair
...
def main():
    ...
    parser.add_argument("--replan-interval", type=int, default=15, help="Steps between replanning for planner-worker mode (default: 5)")
    ...
    if args.agent_type == "planner-worker":
        ...
        agent_pair = ParallelAgentPair(worker_0, worker_1)
