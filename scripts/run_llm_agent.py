...
def main():
    ...
    parser.add_argument("--agent-type", choices=["llm", "planner-worker"], default="planner-worker", help="Agent architecture: llm (LLMAgent+partner) or planner-worker (Planner+2Workers)")
    ...
    model = (
        ...
        or os.getenv("OVERCOOKED_LLM_MODEL")
        or "gpt-4o"
    )
    api_base = (
        os.getenv("LLM_API_BASE")
        or os.getenv("TRITON_API_BASE")
